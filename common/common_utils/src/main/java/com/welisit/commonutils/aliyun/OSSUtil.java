package com.welisit.commonutils.aliyun;
    ...
    public static R uploadFileToOss(
        ...
        try {
            ...
            if(responseMessage == null) {
                ...
                // 当前方法返回成功
                return R.ok().data("url", ossFileAccessPath);
            } else {
                // 获取响应状态码
                ...
                // 当前方法返回失败
                return R.error().message(errorMessage).code(statusCode);
            }
        } catch (Exception e) {
            e.printStackTrace();
